...
def click():
      printInput()
      lezgo = Button(win, text="Next",font=("", 20),command=output,bg='#748EFF').place(x = 720, y = 530)
   
#-----------------------------------------------------------------------------------------------------------

#button

submit=Button(win,text='Submit',font=("", 20),command=click,bg='#748EFF').place(x = 450, y = 530)
