...
class login_window:
    def __init__(self, root):
        ...
        self.bg = ImageTk.PhotoImage(file = "Loginform\pexels-jot-2179483.jpg") #Bg image of the whole page
        ...
        userprofile = Image.open(r"Loginform\userprofileimg.png")          #The user profile circle
    ...
    # ==========ICON IMAGES================================================================================
        ...
        userfrontimage = Image.open(r"Loginform\userprofileremovedbg.png")          #The user profile circle
        ...
        passfrontimage = Image.open("Loginform\passfront.jpg")          #The user profile circle
...
# ================= bg image ============================================================================================
        self.bg = ImageTk.PhotoImage(file = "Loginform\pexels-jakub-novacek-924824.jpg")
        bg_lbl = Label(self.root, image = self.bg)
        bg_lbl.place(x = 0, y = 0, relwidth = 1, relheight = 1)

# ================= left image ===========================================================================================
        self.leftbg = ImageTk.PhotoImage(file = "Loginform\MUSIC for your every rant.jpg")
